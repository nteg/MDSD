...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Control Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.nagarro.appBuilderDSL.impl.ControlValueImpl#getControl <em>Control</em>}</li>
 *   <li>{@link com.nagarro.appBuilderDSL.impl.ControlValueImpl#getControlAccess <em>Control Access</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlValueImpl extends SetInstructionAssignmentImpl implements ControlValue
{
  /**
  ...
  {
    return AppBuilderDSLPackage.Literals.CONTROL_VALUE;
  }
    ...
    if (control != null && control.eIsProxy())
    {
      ...
      if (control != oldControl)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, AppBuilderDSLPackage.CONTROL_VALUE__CONTROL, oldControl, control));
      }
    }
    return control;
  }
  ...
  public void setControl(Control newControl)
  {
    ...
    control = newControl;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AppBuilderDSLPackage.CONTROL_VALUE__CONTROL, oldControl, control));
  }
  ...
  public void setControlAccess(String newControlAccess)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AppBuilderDSLPackage.CONTROL_VALUE__CONTROL_ACCESS, oldControlAccess, controlAccess));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AppBuilderDSLPackage.CONTROL_VALUE__CONTROL:
        if (resolve) return getControl();
        return basicGetControl();
      case AppBuilderDSLPackage.CONTROL_VALUE__CONTROL_ACCESS:
